                ...
                <div className="flex-1 bg-[var(--primary)] p-10 md:p-16 flex flex-col justify-center relative overflow-hidden text-center md:text-left">
                    ...
                    <div className="relative z-10 max-w-[280px] mx-auto md:mx-0">
                        ...
                        <p className="text-blue-50 text-sm font-medium leading-relaxed opacity-90">
                            Register to unlock access to cutting-edge equipment, track applications, and advance your scientific inquiry.
                        </p>
                    </div>
                </div>
                ...
                <div className="flex-1 bg-[var(--surface)] p-8 md:p-16 flex flex-col justify-center items-center">
                    <div className="w-full max-w-xs">
                        ...
                        <div className="flex flex-col items-center mb-6 md:mb-8">
                            ...
                            <h2 className="text-xl font-bold text-[var(--text)] text-center">Get Started with LIAMS</h2>
                        </div>
                        ...
                        {pendingUserId ? (
                            ...
                            <>
                                <p className="text-[13px] text-[var(--text)] opacity-70 text-center mb-8 px-2 font-medium">
                                    Create your account to manage lab infrastructure, applications, and research resources.
                                </p>

                                <form onSubmit={handleSignupSubmit} className="space-y-4">
                                    <div className="space-y-1.5">
                                        <label className="text-[12px] font-semibold text-[var(--text)] opacity-70">Full Name</label>
                                        <input
                                            type="text"
                                            required
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full h-12 bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-white font-medium rounded-xl transition-all disabled:opacity-50 shadow-lg shadow-blue-500/25 active:scale-[0.98] mt-4"
                                        disabled={signupMutation.isPending}
                                    >
                                ...
                                <div className="mt-8 text-center">
                                    <p className="text-xs text-[var(--text)] opacity-70 font-medium">
                                        Already have an account? <Link to="/login" className="text-[var(--primary)] font-semibold hover:underline opacity-100">Sign in</Link>
                                    </p>
                                </div>
                            </>
                        )}
